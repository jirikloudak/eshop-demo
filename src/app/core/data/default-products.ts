...
export const defaultProducts: Product[] = [
  { 
    ...
    price: 149.99, 
    stock: 25, 
    imageUrl: '/assets/headphones_image.jpg',
    color: 'Black',
  ...
  { 
    ...
    price: 29.99, 
    stock: 50, 
    imageUrl: '/assets/mouse_image.jpg',
    color: 'Gray',
  ...
  { 
    ...
    price: 299.99, 
    stock: 10, 
    imageUrl: '/assets/monitor_image.jpg',
    color: 'Black',
  ...
  { 
    ...
    price: 119.99, 
    stock: 35, 
    imageUrl: '/assets/disk_image.jpg',
    color: 'Silver',
  ...
  { 
    ...
    price: 59.99, 
    stock: 40, 
    imageUrl: '/assets/fitness_band_image.jpg',
    color: 'Blue',
  ...
  { 
    ...
    price: 89.99, 
    stock: 15, 
    imageUrl: '/assets/drone_image.jpg',
    color: 'White',
  ...
  { 
    ...
    price: 19.99, 
    stock: 60, 
    imageUrl: '/assets/light_bulb_image.jpg',
    color: 'Multicolor',
  ...
  { 
    ...
    price: 79.99, 
    stock: 20, 
    imageUrl: '/assets/speaker_image.jpg',
    color: 'Red',
